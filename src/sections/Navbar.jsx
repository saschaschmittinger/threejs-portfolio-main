      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center py-5 mx-auto c-space">
          <div className="flex gap-2 justify-center items-center">
            <svg id="logo-85" className="h-6 w-6" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                className="ccustom"
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            <a href="/" className="text-neutral-400 font-bold text-xl">
              <span className="text-[#5417D7]">SSC </span> <span className="text-white/80">Consult</span>
            </a>
          </div>
          <button
            onClick={toogleMenu}
